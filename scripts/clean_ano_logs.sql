...
delete from ano_logs where message like 'Session start user anton%';
delete from ano_logs where message like 'Session ended user anton%';
...
delete from user where user = 'anton';
delete from user where user = 'caesar';
